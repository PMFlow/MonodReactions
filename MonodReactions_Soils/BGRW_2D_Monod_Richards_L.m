function [c]=BGRW_2D_Monod_Richards_L(c0,cBC,dthtc,I,J,dx,dy,dtt,Vx,Vy,D1,D2,Lc,jb)
...
restr=0; restjump=0; restjumpx=0; restjumpy=0; restf=0;
    ...
    %%%% BCY Left/Right
    nn(1:jb,1)=nBC(1:jb,1); % set to IC on \Gmma_21
    nn(jb+1:J,1)=nn(jb+1:J,2); % no flux left
    nn(1:jb,I)=nBC(1:jb,I); % set to IC on  \Gmma_22 
    nn(jb+1:J,I)=nn(jb+1:J,I-1); % no flux right
    %%%% BCX Bottom/Top
