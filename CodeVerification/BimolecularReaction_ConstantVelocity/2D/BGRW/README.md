...
- 'main_2D_ReactTransp_test.m' is the main program, based on a noniterative scheme, which is used to test the 
...
- 'BGRW_2D.m' is the function for the nonreactive advection-diffusion step computed with the BGRW scheme.
